...
#calculate % of emotion words used each day 
# nrc_word_counts_2 <- nrc_word_counts %>% 
#   group_by(date) %>% 
...
#          anger_perc = 100 * (anger / total_n),
#          antic_perc = 100 * (anticipation / total_n), 
#          disgust_perc = 100 * (disgust / total_n), 
#          fear_perc = 100 * (fear / total_n), 
#          joy_perc = 100 * (joy / total_n), 
#          sad_perc = 100 * (sadness / total_n), 
#          surprise_perc = 100 * (surprise / total_n), 
#          trust_perc = 100 * (trust / total_n)
#          )
# 
# nrc_word_counts_4 <- nrc_word_counts %>% 
#   group_by(date) %>% 
#   summarise(across(sentiment, mean(n)))
...
```{r}
# ggplot(data = nrc_word_counts_2, aes(x = date, y = perc, color = sentiment, fill = sentiment)) + 
#   geom_col() + 
#   theme_classic() + 
#   labs(x = "Date", 
#        y = "% of Sentiment Contributed Per Day ")
# 
# ggplot(data = nrc_word_counts_2, aes(x = date, y = perc, color = sentiment)) + 
#   geom_line() +
#   theme_classic() + 
#   labs(x = "Date", 
#        y = "% of Sentiment Contributed Per Day ")
